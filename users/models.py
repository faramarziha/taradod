...
class CustomUser(AbstractUser):
    ...
    group = models.ForeignKey('attendance.Group', null=True, blank=True, on_delete=models.SET_NULL, verbose_name='گروه')
    shift = models.ForeignKey('attendance.Shift', null=True, blank=True, on_delete=models.SET_NULL, verbose_name='شیفت')
